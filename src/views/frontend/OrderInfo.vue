              ...
              <tr v-for="cart in cartsTotal.carts" :key="cart.id">
                <td class="d-flex align-items-center justify-content-between gap-5 gap-md-10 py-4">
                  ...
                  <div class="d-flex flex-column flex-md-row align-items-md-center w-75">
                    ...
                    <p class="mb-0 fs-5 text-primary text-md-end w-md-25">NT${{ cart.total }}</p>
                  </div>
                </td>
              </tr>
            </tbody>
          ...
          <div class="row">
            ...
            <div class="col-md-8">
              <div class="d-flex justify-content-between">
                <p class="fs-5 mb-2">小計</p>
                <p class="fs-4 mb-2 fw-bold">NT${{ cartsTotal.total }}</p>
              </div>
            </div>
            <div class="col-md-8 offset-md-4">
              <div class="d-flex justify-content-between">
                ...
                <p class="fs-4 mb-2 fw-bold">NT${{ shipping }}</p>
              </div>
            </div>
            <div class="col-md-8 offset-md-4">
              <div class="d-flex justify-content-between">
                <p class="fs-5 mb-2">總計</p>
                <p class="fs-4 mb-2 fw-bold">NT${{ cartsTotal.final_total + shipping }}</p>
              </div>
            </div>
          </div>
        </section>
